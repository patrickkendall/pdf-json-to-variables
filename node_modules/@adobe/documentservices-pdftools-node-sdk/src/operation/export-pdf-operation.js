		...
		getTargetFileExtension(targetExportFormat) {
			switch (targetExportFormat) {
				...
				case this.supportedTargetFormats.PNG:
					return ExtensionMediaTypeMapping.zip.extension;
				default:
...
class ExportPDFOperation {
	...
	execute(context) {
		...
		const targetFileName = getRandomFileNameWithExtension(allowedConfiguration.getTargetFileExtension(this.targetFormat)),
